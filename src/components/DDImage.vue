...
const dropFunction = (e: DragEvent) => {
    ...
    const imagData = createInfo(file)
    images.value?.push(imagData)    
    emits('return', imagData)
}
...
<template>
    <div class="image-container"  @drop.prevent="dropFunction" @dragover.prevent>
